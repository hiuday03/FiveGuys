...
// tổng hóa đơn trong  ngày
    ...
    $scope.listCustomerDay = function () {
       ...
       var today6 = new Date();
        ...
        //list customes--------------------------------------
        $http.get(api + "/list-customer-day/" + `${todayfomat}`, todayfomat).then(function (getall) {
            $scope.listcustomerday = getall.data;
        })
        $http.get(api + "/list-customer-day/" + `${today1fomat}`, today1fomat).then(function (getall1) {
            $scope.listcustomerday1 = getall1.data;
        })
        $http.get(api + "/list-customer-day/" + `${today2fomat}`, today2fomat).then(function (getall2) {
            $scope.listcustomerday2 = getall2.data;
        })
        $http.get(api + "/list-customer-day/" + `${today3fomat}`, today3fomat).then(function (getall3) {
            $scope.listcustomerday3 = getall3.data;
        })
        $http.get(api + "/list-customer-day/" + `${today4fomat}`, today4fomat).then(function (getall4) {
            $scope.listcustomerday4 = getall4.data;
        })
        $http.get(api + "/list-customer-day/" + `${today5fomat}`, today5fomat).then(function (getall5) {
            $scope.listcustomerday5 = getall5.data;
        })
        $http.get(api + "/list-customer-day/" + `${today6fomat}`, today6fomat).then(function (getall6) {
            $scope.listcustomerday6 = getall6.data;
        })

        //List bill--------------------------------------------------------
        $http.get(api + "/list-bill-day/" + `${todayfomat}`, todayfomat).then(function (getbill) {
            $scope.listbillday = getbill.data;
        })
        $http.get(api + "/list-bill-day/" + `${today1fomat}`, today1fomat).then(function (getbill1) {
            $scope.listbillday1 = getbill1.data;
        })
        $http.get(api + "/list-bill-day/" + `${today2fomat}`, today2fomat).then(function (getbill2) {
            $scope.listbillday2 = getbill2.data;
        })
        $http.get(api + "/list-bill-day/" + `${today3fomat}`, today3fomat).then(function (getbill3) {
            $scope.listbillday3 = getbill3.data;
        })
        $http.get(api + "/list-bill-day/" + `${today4fomat}`, today4fomat).then(function (getbill4) {
            $scope.listbillday4 = getbill4.data;
        })
        $http.get(api + "/list-bill-day/" + `${today5fomat}`, today5fomat).then(function (getbill5) {
            $scope.listbillday5 = getbill5.data;
        })
        $http.get(api + "/list-bill-day/" + `${today6fomat}`, today6fomat).then(function (getbill6) {
            $scope.listbillday6 = getbill6.data;
        })
        //List Doanh thu--------------------------------------------------------
        $http.get(api + "/list-doanhthu-day/" + `${todayfomat}`, todayfomat).then(function (getbill) {
            $scope.listdoanhthuday = getbill.data;
        })
        $http.get(api + "/list-doanhthu-day/" + `${today1fomat}`, today1fomat).then(function (getbill1) {
            $scope.listdoanhthuday1 = getbill1.data;
        })
        $http.get(api + "/list-doanhthu-day/" + `${today2fomat}`, today2fomat).then(function (getbill2) {
            $scope.listdoanhthuday2 = getbill2.data;
        })
        $http.get(api + "/list-doanhthu-day/" + `${today3fomat}`, today3fomat).then(function (getbill3) {
            $scope.listdoanhthuday3 = getbill3.data;
        })
        $http.get(api + "/list-doanhthu-day/" + `${today4fomat}`, today4fomat).then(function (getbill4) {
            $scope.listdoanhthuday4 = getbill4.data;
        })
        $http.get(api + "/list-doanhthu-day/" + `${today5fomat}`, today5fomat).then(function (getbill5) {
            $scope.listdoanhthuday5 = getbill5.data;
        })
        $http.get(api + "/list-doanhthu-day/" + `${today6fomat}`, today6fomat).then(function (getbill6) {
    ...
    function renderChart() {
        ...
        new ApexCharts(document.querySelector("#reportsChart"), {
            series: [{
                name: 'Sales',
                data: [$scope.listbillday6, $scope.listbillday5, $scope.listbillday4, $scope.listbillday3, $scope.listbillday2, $scope.listbillday1, $scope.listbillday],
            }, {
                name: 'Revenue',
                data: [$scope.listdoanhthuday6, $scope.listdoanhthuday5, $scope.listdoanhthuday4, $scope.listdoanhthuday3, $scope.listdoanhthuday2, $scope.listdoanhthuday1, $scope.listdoanhthuday]
            }, {
                name: 'Customers',
