...
app.controller("material-ctrl", function ($scope, $http, $timeout) {
  ...
  $scope.paper = {
    ...
    get items() {
      let start = this.page * this.size;
      return $scope.material.slice(start, start + this.size);
    },
    get count() {
      return Math.ceil((1.0 * $scope.material.length) / this.size);
    },
    first() {
      this.page = 0;
    },
...
app.controller("color-ctrl", function ($scope, $http, $timeout) {
  ...
  $scope.paper = {
    ...
    get items() {
      let start = this.page * this.size;
      return $scope.color.slice(start, start + this.size);
    },
    get count() {
      return Math.ceil((1.0 * $scope.color.length) / this.size);
    },
    first() {
      this.page = 0;
    },
