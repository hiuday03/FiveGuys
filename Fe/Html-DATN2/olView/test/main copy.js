...
//           // Assuming response.data is an array of cities
//           $scope.cities = response.data.data;
// // $scope.getNameDistrict(269,90816)
...
//   $scope.province();
//   // Kiểm tra xem mảng cities có tồn tại không
//   if ($scope.cities) {
//       // Tìm thành phố được chọn trong mảng cities
//       var selectedCity = $scope.cities.find(function(city) {
//           return city.ProvinceID === cityId;
//       });

//       // Cập nhật model selectedProvinceName
//       if (selectedCity) {
//           $scope.selectedProvinceName = selectedCity.NameExtension[0];
//           console.log('$scope.selectedProvinceName:', $scope.selectedProvinceName);
//       }
//   }
// };
...
//       console.log($scope.billAddressDistrict);
//     }
//   });
// };
...
//       if (selectedWard) {
//         // Gán giá trị của selectedWard.WardCode cho billAddressWard
//         $scope.billAddressWard = selectedWard.WardCode;
// $scope.calculateShippingFee($scope.billAddressDistrict,$scope.billAddressWard)
        
//       } else {
//         // Trong trường hợp không tìm thấy giá trị, bạn có thể xử lý theo cách phù hợp với ứng dụng của bạn.
//         console.log("Không tìm thấy phường/xã với WardCode: " + wardId);
//       }

//       console.log($scope.billAddressWard);
//     }
//   });
// };
...
// // $scope.billAddressCity = 269;

// // $scope.getNameDistrict(269,2264)
// // // $scope.billAddressWard = 13010;
// // $scope.getNameWard(2264,90816)
